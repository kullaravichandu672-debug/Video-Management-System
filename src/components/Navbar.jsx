    ...
    return (
      <nav className="bg-black text-gray-200 flex justify-between items-center p-4 h-20 text-sm md:text-[15px] font-medium text-nowrap">
        ...
        <ul className="hidden xl:flex space-x-6">
          ...
          <Link to="/tv"><li className="hover:text-red-500">Tv Shows</li></Link>
          <Link to="/movies"><li className="hover:text-red-500">Movies</li></Link>
          <Link to="/anime"><li className="hover:text-red-500">Anime</li></Link>
          <Link to="/games"><li className="hover:text-red-500">Games</li></Link>
          <Link to="/new-popular"><li className="hover:text-red-500">New & Popular</li></Link>
          <Link to="/upcoming"><li className="hover:text-red-500">Upcoming</li></Link>
          <Link to="/saved"><li className="hover:text-red-500 cursor-pointer">Saved</li></Link>
          </ul>
