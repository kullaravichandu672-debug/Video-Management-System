    ...
    >
      ...
      <div className='max-w-[450px] w-full bg-black bg-opacity-75 rounded px-8 py-14 mx-auto mt-8'>
        ...
        <form className='flex flex-col space-y-4'>
          <input type="text" placeholder="username" className="w-full h-[50px] bg-[#333] text-white rounded px-5 text-base"/>
          <input type="password" placeholder="password" className="w-full h-[50px] bg-[#333] text-white rounded px-5 text-base" />
